...
import com.edu.exmg.admin.api.LocalDeptUserAPI;
import com.edu.exmg.admin.api.RemoteUserAPI;
import com.edu.exmg.admin.api.RoleMenuPermissionAPI;
...
public class AdminRbacConfiguraion extends WebMvcConfigurationSupport implements ImportSelector {
    ...
    private static class UserArgumentResolve implements HandlerMethodArgumentResolver {
        ...
        public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
            ...
            return session.getAttribute(SessionKeyEnum.CURRENT_USER.name());
        }
    }
