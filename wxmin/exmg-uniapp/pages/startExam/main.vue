<template>
  <div class="exam-container">
    <div class="exam-top">
      <div>{{pivotText}}</div>
      <div><button plain type="primary" size="mini" @click="onSubmit">交卷</button></div>
    </div>
    ...
    <van-row v-if="currentPics">
      <image class="uni-header-image" :src="currentPics" />
    </van-row>
    ...
    <div class="exam-bottom">
        ...
        <button plain type="primary" size="small" @click="prev">上一题</button>
        <button plain type="primary" size="small" @click="next">下一题</button>
    </div>
